...
This system allows restaurants to manage menus, orders, customers, and admins efficiently. It is built using Laravel and supports both frontend ordering and backend management.
...
- Order history, statistics, and real-time updates
